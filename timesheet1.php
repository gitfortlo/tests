...
<?php include("errors.php");?>
    <form method="POST" action="timesheet1.php">
        <table>
            <thead>
                <tr>
                    <th>Name</th>
            ...
            <tbody>
                <tr>
                    <td><input type="text" name="name" id="name" required <?php echo $name?>></td>
                    <td>
                        <select name="task" id="task" required <?php echo $project?>>
                    ...
                    <td>
                        <input type="number" name="hours" id="hours" required <?php echo $hours?>> hours
                        <input type="number" name="minutes" id="hours" required <?php echo $minutes?>> minutes
                    </td>
        ...
        <input type="submit" class="btn" name="sub_timesheet1" value="Submit Timesheet">
        </div>
    </form>
    ...
    <script>
        function addRow() {
            ...
            newRow.innerHTML = `
            <form method="POST" action="timesheet1.php">
                <td><input type="text" name="name" required <?php echo $name; ?>></td>
                <td>
                    <select name="task" required <?php echo $project ?>>
                ...
                <td>
                    <input type="number" name="hours" required '<?php echo $hours; ?>'> hours
                    <input type="number" name="minutes" required '<?php echo $minutes; ?>'> minutes
                </td>
